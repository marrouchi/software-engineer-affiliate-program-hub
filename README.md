...
2. **[Hexabot.ai](https://www.hexabot.ai/)**: Hexabot is an open, self-hosted, AI chatbot and workflow automation platform built for developers, startups, agencies, and businesses that want to create powerful conversational experiences and automated workflows. Check their [affiliate program](https://license.hexabot.ai/affiliates).
